...
!TO "MONITOR-EXT.BIN",plain		; Generic filename
...
;================================================================================
; [$8000] CODE FOR EXTERNAL ROM SOCKET - $8000-$9FFF (8K Size)
;================================================================================
; This code goes in a separate ROM socket
...
;================================================================================
; [$FD42] START OF MONITOR ROM @ $FD00
;================================================================================
; This code will be in the normal C4 monitor ROM socket $FD00-FFFF
